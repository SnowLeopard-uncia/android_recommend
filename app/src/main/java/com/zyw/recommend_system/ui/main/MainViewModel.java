...
import com.zyw.recommend_system.logic.paging_service.ExecutorHotRecommend;
...
import com.zyw.recommend_system.logic.paging_service.ExecutorUserRecommend;
...
public class MainViewModel extends ViewModel {
    ...
    public LiveData<PagingData<Article>> getRecommendArticlePaging(Boolean isFirst,String tag){
        CoroutineScope viewModelScope= ViewModelKt.getViewModelScope(this);
        Pager<Integer, Article> pager = new Pager<Integer, Article>(pagingConfig,
                ()->new ArticleDataSource(new ExecutorUserRecommend(executorService,isFirst,tag)));    //构造函数
        return PagingLiveData.cachedIn(PagingLiveData.getLiveData(pager),viewModelScope);
    }

    public LiveData<PagingData<Article>> getHotArticlePaging(String tag){
        CoroutineScope viewModelScope= ViewModelKt.getViewModelScope(this);
        Pager<Integer, Article> pager = new Pager<Integer, Article>(pagingConfig,
                ()->new ArticleDataSource(new ExecutorHotRecommend(executorService,tag)));    //构造函数
        return PagingLiveData.cachedIn(PagingLiveData.getLiveData(pager),viewModelScope);
    }
    ...
    public Boolean getFirst() {
        return Repository.getInstance().getFirstIn();
    }
    ...
    public int getTag() {
        return Repository.getInstance().getTag();
    }

    public void setTag(int tag) {
        Repository.getInstance().setTag(tag);
    }
